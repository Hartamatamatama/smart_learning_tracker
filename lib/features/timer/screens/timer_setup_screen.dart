...
class _TimerSetupScreenState extends ConsumerState<TimerSetupScreen> {
  ...
  final _focusCtrl = TextEditingController(
    text: '${AppConstants.defaultFocusMinutes}',
  );
  final _breakCtrl = TextEditingController(
    text: '${AppConstants.defaultBreakMinutes}',
  );
  ...
  // Kembali: pop jika ada stack di bawahnya, kalau tidak (mis. dibuka sebagai
  // root dari alur "Sesi Baru") arahkan ke Home agar back tidak keluar app.
  void _back() => context.canPop() ? context.pop() : context.go(AppRoutes.home);
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      // Jika bisa pop, biarkan sistem menanganinya; jika tidak (root),
      // tangani back fisik dengan pindah ke Home.
